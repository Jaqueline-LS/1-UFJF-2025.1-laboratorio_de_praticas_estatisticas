...
grupo_ali<-analise2.new$soma_porcoes_dia_cereais_total

boot_lasso<-function(grupo_ali)
{
  library(car)
  modelo_lm<-lm(grupo_ali~idade_atual_anos + sexo + idade_1a_crise_meses + tea + di + tdah + dificuldade_motora + 
  ...
  X <- model.matrix(
    grupo_ali ~ idade_atual_anos + sexo + idade_1a_crise_meses + tea + di + tdah + dificuldade_motora + 
      disfagia + rec_vomito_diarreia + constipacao + atraso_desenvolvimento_sn +
...
boot_lasso(analise2.new$soma_porcoes_semana_doces_salgadinhos_guloseimas)

boot_lasso(analise2.new$soma_porcoes_dia_cereais_saudaveis)

boot_lasso(analise2.new$soma_porcoes_dia_carnes_ovos)

boot_lasso(analise2.new$soma_porcoes_semana_embutidos)
