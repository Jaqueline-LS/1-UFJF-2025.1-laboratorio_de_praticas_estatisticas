...
milk_dairy<-analise2.new$soma_porcoes_dia_laticinios


modelo_lm<-lm(milk_dairy~idade_atual_anos + sexo + idade_1a_crise_meses + tea + di + tdah + dificuldade_motora + 
...
X <- model.matrix(
  milk_dairy ~ idade_atual_anos + sexo + idade_1a_crise_meses + tea + di + tdah + dificuldade_motora + 
    disfagia + rec_vomito_diarreia + constipacao + atraso_desenvolvimento_sn +
...
ajuste.min<-lm(milk_dairy~idade_atual_anos+sexo+tdah+dificuldade_motora+disfagia, data = analise2.new)
summary(ajuste.min)
...
formula_lasso <-  milk_dairy ~ idade_atual_anos + sexo + idade_1a_crise_meses +
