...
{
  jpeg(file=paste0("Resultados/", nome.plot,"_boxplots2.jpg"), width = 1500, height = 800, quality = 100, pointsize = 20)
  ...
  plot(Y~idade_1a_crise_meses,pch=20, 
       xlab="", 
       ylab="",
       main=paste0("Idade_1a_crise vs. Porções(",nome.plot,") "))
  dev.off()
